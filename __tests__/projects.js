...
describe("RepositoryProjectsManager.sync() posts requests to the API", () => {
  ...
  beforeEach(() => {
    ...
    jest.spyOn(apiWrapper, "fetchOrganiztion").mockImplementation(() => ({
      organization: {
        id: "O_0000000001",
        name: "Babbel Sandbox",
      },
    ...
    jest
      .spyOn(apiWrapper, "fetchRepository")
    ...
    jest
      .spyOn(apiWrapper, "createProject")
  ...
  test("when one project is missing", async () => {
    const titles = ["layer-200/module-1", "layer-100/module-2"];
